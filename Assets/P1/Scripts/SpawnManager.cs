...
public class SpawnManager : MonoBehaviour
{
    ...
    void SpawnEnemy()
    {
        ...
        Instantiate(enemyPrefabs[enemyIndex], new Vector3(x,0,24.2f), enemyPrefabs[enemyIndex].transform.rotation);
    ...
    void SpawnPowerup()
    {
        ...
        Instantiate(powerupPrefab, new Vector3(xz, 0, xz), powerupPrefab.transform.rotation);
    }
}
